...
public class OrderProductServiceImpl implements OrderProductService {
    ...
    @Override
    @Transactional
    public void removeProductFromOrder(Order order, ProductDto productDto) {
        ...
        try {
            ...
            order.setFullPrice(order.getFullPrice() - orderProduct.getProductPrice());
            ...
            log.warn("in remove product from order: product not found by id {}",product.getId() );
        }
    ...
    @Override
    @Transactional
    public void saveProductToOrder(Order order, ProductDto productDto) {
        Product product=modelMapper.map(productDto,Product.class);
